    ...
    <footer className="bg-gray-800 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white text-lg font-bold mb-4">Танилцуулга</h3>
            <p className="mb-4">
              Манай сэтгэл судлалын төв нь судалгааны аргуудыг бусадтай
              хуваалцах, сэтгэл зүйн хүрээн хэрэглэх бараа бүтээгдэхүүн түгээх.
              хэрэгцээт зөвөлгөө нийлэл болон сэтгэл зүйн зөвөлгөөний үйлчилгээ
              үзүүлдэг.
            </p>
          ...
          <div>
            <h3 className="text-white text-lg font-bold mb-4">Туслах цэс</h3>
          ...
          <div>
            <h3 className="text-white text-lg font-bold mb-4">Холбоо барих </h3>
            <ul className="space-y-2">
              <li>info@meb.mn</li>
              <li>7777-1441</li>
              <li> Эрхүүгийн гудамж, Ардчиллын ордон 103 тоот</li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Melody Bird.</p>
        </div>
      </div>
    </footer>
  );
