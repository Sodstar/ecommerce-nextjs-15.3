...
export default function ShoppingCartPage() {
  const [cartItems, setCartItems] = useState([
    ...
    },
    {
      ...
      price: 149.99,
      originalPrice: null,
      image: "https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?q=80&w=300&auto=format&fit=crop",
      quantity: 2,
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1588854337236-6889d631faa8?q=80&w=300&auto=format&fit=crop",
      quantity: 1,
      variant: "Natural Oak",
      inStock: false,
      maxQuantity: 0
  ...
  const recommendedProducts = [
    {
      ...
      name: "Desk Lamp",
      price: 49.99,
      image: "https://images.unsplash.com/photo-1534189289-18e4dbe8f1fc?q=80&w=200&auto=format&fit=crop"
    },
    {
      id: 102,
      name: "Office Desk",
    ...
    },
    {
      ...
      name: "Bookshelf",
      price: 129.99,
      image: "https://images.unsplash.com/photo-1616150638538-ffb0679a3fc4?q=80&w=200&auto=format&fit=crop"
    }
  ];
  ...
  const handleQuantityChangeWithAnimation = (itemId: number, newQuantity: number) => {
    if (newQuantity >= 1 && newQuantity <= cartItems.find(item => item.id === itemId)?.maxQuantity!) {
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex justify-between">
                            <div>
                              <h3 className="font-medium text-lg leading-tight">
                                <Link href="/home2/detail" className="hover:text-amber-600 transition-colors">
                                  {item.name}
                                </Link>
                              </h3>
                              <p className="text-xs text-zinc-500 mt-1 flex items-center gap-1">
                                <span className="w-3 h-3 rounded-full inline-block" style={{ backgroundColor: item.variant === "Classic Gray" ? "#6B7280" : "#1F2937" }}></span>
                                {item.variant}
                              </p>
                          ...
                          <div className="mt-4 flex flex-wrap items-center justify-between gap-4">
                            <motion.div 
                              ...
                              animate={{ scale: animateQuantity === item.id ? 1.05 : 1 }}
                            ...
                            >
                              <Button
                                ...
                                onClick={() => handleQuantityChangeWithAnimation(item.id, item.quantity - 1)}
                              >
                          ...
                          {!item.inStock && (
                            <div className="mt-3">
                              <Badge variant="outline" className="bg-red-50 text-red-600 border-red-100 gap-1 py-1.5">
                          ...
                          {item.inStock && item.maxQuantity <= 3 && (
                            <div className="mt-3">
                              <Badge variant="outline" className="bg-amber-50 text-amber-600 border-amber-100 gap-1 py-1.5">
                                <Info className="h-3.5 w-3.5" />
              ...
              <div className="bg-white rounded-3xl shadow-sm border border-zinc-100 overflow-hidden sticky top-20">
                ...
                <div className="p-6 space-y-5">
                  <div className="flex justify-between text-sm">
                    <span className="text-zinc-500">Subtotal ({cartItems.reduce((sum, item) => sum + item.quantity, 0)} items)</span>
                  ...
                  {savedAmount > 0 && (
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-green-600 font-medium">-${savedAmount.toFixed(2)}</span>
                    </div>
                  )}
                ...
                <div className="p-6 bg-zinc-50 border-t border-zinc-100">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-500">Expected delivery: 3-5 business days</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-full bg-zinc-100 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-500">Shop with confidence</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
              {recommendedProducts.map((product, index) => (
                ...
                >
                  ...
                  <h3 className="font-medium text-lg mb-1 group-hover:text-amber-600 transition-colors">{product.name}</h3>
              ...
              <Accordion type="single" collapsible className="bg-white rounded-2xl shadow-sm">
                <AccordionItem value="shipping" className="border-b border-zinc-100">
                  ...
                  <AccordionContent className="px-6 pb-5 pt-0 text-zinc-600">
                    <div className="pl-11">
                      Standard shipping takes 3-5 business days. Expedited shipping options
                      are available at checkout for faster delivery. All orders are processed
                      within 24 hours.
                    </div>
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="returns" className="border-b border-zinc-100">
                  <AccordionTrigger className="py-5 px-6 hover:no-underline">
                    <div className="flex items-center gap-3">
                      <div className="h-8 w-8 rounded-full bg-zinc-50 flex items-center justify-center flex-shrink-0">
                  ...
                  <AccordionContent className="px-6 pb-5 pt-0 text-zinc-600">
                    <div className="pl-11">
                      ...
                      in original condition with tags attached and original packaging.
                ...
                <AccordionItem value="payment" className="border-0">
                  ...
                  <AccordionContent className="px-6 pb-5 pt-0 text-zinc-600">
                    <div className="pl-11">
                      ...
                      PayPal, and Apple Pay. All transactions are secure and encrypted.
